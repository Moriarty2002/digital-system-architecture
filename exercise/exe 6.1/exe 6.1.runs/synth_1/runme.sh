...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 6.1/exe 6.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PO_PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PO_PC.tcl
