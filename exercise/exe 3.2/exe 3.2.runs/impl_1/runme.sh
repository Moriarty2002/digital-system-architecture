...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 3.2/exe 3.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log automa2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source automa2.tcl -notrace
