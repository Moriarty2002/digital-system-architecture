...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 3.2/exe 3.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log automa2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source automa2.tcl
