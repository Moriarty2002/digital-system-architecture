...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 1.2 - Rete inteconnessione 16_4/exe 1.2 - Rete inteconnessione 16_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnection_16_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnection_16_4.tcl
