...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 5.1/exe 5.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chronometer_60.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chronometer_60.tcl
