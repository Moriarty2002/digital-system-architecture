...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe_3.1/exe_3.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log automa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source automa.tcl
