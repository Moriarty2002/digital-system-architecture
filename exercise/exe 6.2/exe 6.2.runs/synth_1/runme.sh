...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 6.2/exe 6.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Controlled_PO_PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Controlled_PO_PC.tcl
