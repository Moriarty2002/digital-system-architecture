...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 8.1 new/exe 8.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A_B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A_B.tcl
