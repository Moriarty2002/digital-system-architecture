...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 1.3/exe 1.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnection_16_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interconnection_16_4.tcl -notrace
