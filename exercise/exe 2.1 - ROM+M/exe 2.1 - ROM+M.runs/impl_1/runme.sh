...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 2.1 - ROM+M/exe 2.1 - ROM+M.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m_system.tcl -notrace
