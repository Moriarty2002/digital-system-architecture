...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/exercise/exe 2.1 - ROM+M/exe 2.1 - ROM+M.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_system.tcl
