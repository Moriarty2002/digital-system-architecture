...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/VIVADO-PROJECTS/ROM/ROM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_N_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_N_4.tcl
