...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/VIVADO-PROJECTS/ROM_16x8/ROM_16x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_16x8_one_hot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_16x8_one_hot.tcl
