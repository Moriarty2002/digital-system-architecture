...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/VIVADO-PROJECTS/encoder/encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_8_4.tcl
