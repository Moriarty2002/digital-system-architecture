...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/VIVADO-PROJECTS/counter/counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Contatore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Contatore.tcl
