...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/VIVADO-PROJECTS/demux_1_16/demux_1_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_1_16.tcl
