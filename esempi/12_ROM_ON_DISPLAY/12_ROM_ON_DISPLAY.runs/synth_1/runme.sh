...
HD_PWD='C:/VIVADO-PROJECTS/12_ROM_ON_DISPLAY/12_ROM_ON_DISPLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_selector_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_selector_onboard.tcl
