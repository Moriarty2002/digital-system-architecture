...
HD_PWD='C:/VIVADO-PROJECTS/12_ROM_ON_DISPLAY/12_ROM_ON_DISPLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_selector_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROM_selector_onboard.tcl -notrace
