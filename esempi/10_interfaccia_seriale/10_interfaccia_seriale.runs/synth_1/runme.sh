...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/esempi/10_interfaccia_seriale/10_interfaccia_seriale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sis_tot_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sis_tot_tb.tcl
