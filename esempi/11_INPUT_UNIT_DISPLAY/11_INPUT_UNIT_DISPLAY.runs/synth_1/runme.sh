...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/esempi/11_INPUT_UNIT_DISPLAY/11_INPUT_UNIT_DISPLAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_on_board.tcl
