...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/esempi/11_INPUT_UNIT_DISPLAY/11_INPUT_UNIT_DISPLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_on_board.tcl -notrace
