...
HD_PWD='Z:/University/Architettura Sistemi Digitali/VHDL/esempi/RCA_generate/RCA_generate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_Nbit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_Nbit.tcl
